module Document
  module Fields
    class TimeRangeFieldPresenter < CompositeFieldPresenter
      ...
      #   from =
      #     (I18n.l(record.begin.in_time_zone, format: format) if record.begin && record.begin.is_a?(Time) && record.begin != -Float::INFINITY)
      #   to =
      #     (I18n.l(record.end.in_time_zone, format: format) if record.end && record.end.is_a?(Time) && record.end != Float::INFINITY)
      ...
      def value_for_preview
        ...
        from =
          (I18n.l(record.begin) if record.begin && record.begin.is_a?(Time) && record.begin != -Float::INFINITY)
        to =
          (I18n.l(record.end) if record.end && record.end.is_a?(Time) && record.end != Float::INFINITY)
      ...
      private
        ...
        def min_begin
          ...
          if @model.options.begin_from_now?
            ...
            a > b ? a.strftime(format) : b.strftime(format)
          end
        end
        ...
        def max_begin
          ...
          if @model.options.end_to_now?
            (record.end - minimum_distance_minutes).strftime(format)
          elsif @model.options.end_to_time?
            (@model.options.end - minimum_distance_minutes).strftime(format)
          end
        end
        ...
        def min_end
          ...
          minimum_distance_minutes = 1.minute if minimum_distance_minutes.zero?
          if @model.options.begin_from_now?
            (record.begin + minimum_distance_minutes).strftime(format)
          elsif @model.options.begin_from_time?
            (@model.options.begin + minimum_distance_minutes).strftime(format)
          end
        end
        ...
        def max_end
          ...
          record = value
          if @model.options.end_to_now?
            record.end.strftime(format)
          elsif @model.options.end_to_time?
            @model.options.end.strftime(format)
            ...
            a > b ? b.strftime(format) : a.strftime(format)
          end
        end
