  ...
  module Fields
    class TimeRangeFieldPresenter < CompositeFieldPresenter
      ...
      def value_for_preview
        ...
        from =
          (I18n.l(record.begin.in_time_zone.strftime(format)) if record.begin && record.begin != -Float::INFINITY)
        to =
          (I18n.l(record.end.in_time_zone.strftime(format)) if record.end && record.end != Float::INFINITY)
