module Document
  class BareForm < ApplicationRecord
    ...
    has_many :fields, -> { order(:position_on_form) }, class_name: Fbuilder.config.document.field_model_class, dependent: :destroy, counter_cache: :fields_count, index_errors: true, foreign_key: "form_id", inverse_of: :form
