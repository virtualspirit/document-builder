      ...
      module Fields
        module Validations
          module Numericality
            ...
            included do
              embeds_one :numericality, class_name: "Document::Concerns::Models::Fields::Validations::Numericality::NumericalityOptions"
              ...
              validate do
                unless numericality.valid?
                  errors.add(:numericality, :invalid)
                  numericality.errors.each {|e| errors.import e, **e.options.merge(attribute: "numericality.#{e.attribute}")}
                end
              end
            end
            ...
            class NumericalityOptions < Document::FieldOptions
